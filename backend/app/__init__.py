...
def create_app(config_name=None, enable_socketio=True):
    ...
    try:
        ...
        app.register_blueprint(final_blueprints['ui_batch_routes'])  # Blueprint has internal url_prefix='/api/ui'
        ...
        def log_startup_summary():
            ...
            blueprint_url_prefixes = {
                ...
                'homepage_batch_routes': '/api/batch',
                'ui_batch_routes': '/api/ui/batch',
