import sys
import os
# ensure the backend repo root (parent of the "app" package) is on sys.path
# seed.py is at backend/app/seeding/seed.py, so go up two levels to reach backend/
...
def seed_database():
    ...
    # Delete dependent order rows before variants to avoid FK constraint violations
    db.session.query(ProductCompatibility).delete()
    db.session.query(Inventory).delete()
    db.session.query(CartItem).delete()
    db.session.query(Cart).delete()
    # Order items reference product_variants -> delete them first
    ...
    admin = User(
        ...
        avatar_url="//images/screenshot-20from-202025-02-18-2013-30-22.png",
        is_active=True,
        email_verified=True,
        phone_verified=True,
    ...
    brands = [
        ...
        },
        {
            ...
            "logo_url": "https://images.unsplash.com/photo-1611186871348-b1ce6996e52c9?w=100&h=100&fit=crop",
        ...
        },
        {
            ...
            "logo_url": "https://images.unsplash.com/photo-1610945415295-d9bbf067e5c?w=100&h=100&fit=crop",
    ...
    product_images_data = {
        ...
        "athletic-performance-hoodie": [
            ...
            "https://images.unsplash.com/photo-1521572163474-6864f9cf17ca?w=800&h=800&fit=crop"
        ],
        ...
        "advanced-fitness-smartwatch": [
            ...
            "https://images.unsplash.com/photo-1508685096489-7aacc2a03b1?w=800&h=800&fit=crop",
        ...
        "professional-skincare-set": [
            ...
            "https://images.unsplash.com/photo-1556228720-195a662e8a03?w=800&h=800&fit=crop",
        ...
        "premium-yoga-mat": [
            ...
            "https://images.unsplash.com/photo-1544367567-0f2fcb00990b?w=800&h=800&fit=crop",
    ...
    promotions = [
        ...
        },
        {
            ...
            "min_order_value": 0.0,
            "max_discount": None,
            "product_ids": ""  # leave empty or populate with specific product IDs if desired
        }
    ]
    ...
    db.session.query(SidePanel).delete()
    ...
    side_panels_data = [
        # Product Showcase panels
        {
            ...
            "features": ["Latest trends", "Premium quality", "Limited edition"],
            "is_active": True,
            "sort_order": 1,
        },
        {
            ...
            "features": ["Customer favorites", "Highly rated", "Fast shipping"],
            "is_active": True,
            "sort_order": 2,
        },
        # Premium Experience panels
        {
            ...
            "metric": "50% Off",
            "description": "Get exclusive access to premium features and early product launches",
            "icon_name": "crown",
        ...
        },
        {
            ...
            "title": "VIP Club",
            "metric": "Join Now",
            "description": "Experience luxury shopping with our VIP membership program",
            "icon_name": "award",
            "image_url": "https://images.unsplash.com/photo-1553708780-9c0c6ca199e8?w=400&h=300&fit=crop",
            "gradient": "from-amber-600 to-yellow-600",
            "features": ["Early access", "Special discounts", "Personal shopper"],
            "is_active": True,
            "sort_order": 2,
        },
        {
            ...
            "features": ["Time limited", "Stock limited", "No returns"],
            "is_active": True,
            "sort_order": 3,
        },
    ]
    
    for panel_data in side_panels_data:
        side_panel = SidePanel(
            panel_type=panel_data["panel_type"],
            position=panel_data["position"],
            title=panel_data["title"],
            metric=panel_data["metric"],
            description=panel_data["description"],
            icon_name=panel_data["icon_name"],
            image_url=panel_data["image_url"],
            gradient=panel_data["gradient"],
            features=panel_data["features"],
            is_active=panel_data["is_active"],
            sort_order=panel_data["sort_order"],
            created_at=datetime.now(), # timezone.utc removed as it was not imported
            updated_at=datetime.now(), # timezone.utc removed as it was not imported
        )
        db.session.add(side_panel)
