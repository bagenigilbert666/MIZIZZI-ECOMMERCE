"""Homepage Contact CTA Loader - Fetches contact CTA slides for homepage display."""
import logging
...
async def get_homepage_contact_cta_slides() -> List[Dict[str, Any]]:
    """
    Fetch active contact CTA slides for homepage with Redis caching.
