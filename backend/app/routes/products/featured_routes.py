...
def get_fast_trending():
    """ULTRA-FAST: Minimal trending products endpoint."""
    try:
...
@fast_cached_response("featured_trending", ttl=30, key_params=["limit"])
def get_trending():
...
@fast_cached_response("featured_top_picks", ttl=30, key_params=["limit"])
def get_top_picks():
...
@fast_cached_response("featured_new_arrivals", ttl=30, key_params=["limit"])
...
@fast_cached_response("featured_daily_finds", ttl=30, key_params=["limit"])
def get_daily_finds():
...
@fast_cached_response("featured_flash_sale", ttl=30, key_params=["limit"])
def get_flash_sale():
...
@fast_cached_response("featured_luxury_deals", ttl=30, key_params=["limit"])
