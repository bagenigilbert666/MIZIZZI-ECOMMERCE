...
/* ─── Main Luxury Deals Page ─── */
export function LuxuryDealsPageContent({
        ...
        <div className="container py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
            ...
            <p className="text-gray-500 text-sm">
              No luxury deals available at the moment.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mb-5 sm:mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              Discover premium luxury products with exclusive deals
            </p>
          </div>
        ...
        >
          {filteredProducts.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <p className="text-gray-500 text-sm mb-2">No luxury products found</p>
              <button
                onClick={() => {
                  setSearchQuery("")
          ...
          {filteredProducts.length > displayCount && (
            <div className="flex flex-col items-center gap-2 py-6 sm:py-8 bg-white border-t border-gray-100">
              <p className="text-xs text-gray-400">
                ...
                {filteredProducts.length} luxury deals
              </p>
              <button
