  ...
  return (
    <Modal open={isOpen} onOpenChange={onClose} size="sm" closeOnEscape closeOnClickOutside>
      <motion.div
        ...
        className="w-full"
      >
        <div className="rounded-2xl bg-white text-neutral-900 shadow-[0_20px_60px_rgba(0,0,0,0.15)] ring-1 ring-black/5 overflow-hidden">
          {/* Header */}
              ...
              {isSuccess ? (
                ...
                >
                  <motion.div
                    ...
                    className="w-16 h-16 rounded-full bg-neutral-900 flex items-center justify-center"
                  >
                ...
                >
                  ...
                  <motion.button
                    ...
                    disabled={isBusy}
                    whileHover={!isBusy ? { y: -2, boxShadow: "0 6px 16px rgba(0,0,0,0.1)" } : {}}
                    whileTap={!isBusy ? { scale: 0.97 } : {}}
                    transition={{ type: "spring", stiffness: 400, damping: 30 }}
                    className="w-full rounded-xl px-5 py-3.5 flex items-center justify-center gap-3 text-[15px] font-medium ring-1 ring-neutral-200/80 hover:ring-neutral-300 bg-white hover:bg-neutral-50/80 active:bg-neutral-100 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.1)] disabled:opacity-60 disabled:cursor-not-allowed disabled:shadow-[0_1px_4px_rgba(0,0,0,0.04)] transition-all"
                  >
                    {isBusy ? (
                      <>
                  ...
                  <AnimatePresence>
                    {status === "error" && errorMessage ? (
                      <motion.div
                        ...
                        className="rounded-xl bg-red-50/60 ring-1 ring-red-500/15 px-4 py-3"
                      >
                  ...
                  >
                    ...
                    <a
                      className="text-neutral-700 font-medium underline underline-offset-3 hover:text-neutral-900 transition-colors"
                      href="/terms"
                    >
                      Terms
                    </a>{" "}
