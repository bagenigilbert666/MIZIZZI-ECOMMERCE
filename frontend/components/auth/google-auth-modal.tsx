      ...
      <div className="space-y-6">
        <AnimatePresence mode="wait">
          {status === "idle" && (
            ...
            >
              {/* Benefits Section */}
              <div className="bg-gradient-to-br from-cherry-50 to-white rounded-xl p-4 border border-cherry-100 space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <Sparkles className="h-5 w-5 text-cherry-600" />
                  </div>
                  <div>
              ...
              <Button
                ...
                className="w-full h-12 bg-white border-2 border-gray-200 hover:border-cherry-300 text-gray-900 font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
              >
                {status === "loading" ? (
                  <>
              ...
              <div className="text-center text-sm text-gray-600">
                <p>
                  ...
                  <button className="text-cherry-600 hover:text-cherry-700 font-semibold">
          ...
          {status === "loading" && (
            ...
            >
              <Loader2 className="h-10 w-10 animate-spin text-cherry-600 mb-4" />
          ...
          {status === "success" && (
            ...
            >
              ...
              <p className="text-gray-600 text-sm mt-2">Redirecting you...</p>
            </motion.div>
          )}
          ...
          {status === "error" && (
            ...
            >
              ...
              <Button
                ...
                className="w-full h-10 bg-cherry-600 hover:bg-cherry-700 text-white font-semibold rounded-lg"
              >
                Try Again
              </Button>
            </motion.div>
