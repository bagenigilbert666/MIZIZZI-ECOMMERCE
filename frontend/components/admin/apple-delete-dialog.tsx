  ...
  return (
    <>
      ...
      <div
        ...
        onClick={!showSuccess && !isDeleting ? onCancel : undefined}
        ...
        >
          ...
          {showSuccess ? (
            <div className="py-12 px-6 text-center">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-1">Product Deleted</h2>
              <p className="text-sm text-gray-600">The product has been removed from your catalog.</p>
            </div>
          ) : (
            <>
