  ...
  return (
    <Card className="border shadow-sm bg-white">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white focus:ring-2 focus:ring-emerald-300"
            >
                ...
                <Form {...variantForm}>
                  <form onSubmit={variantForm.handleSubmit(onSubmitVariant)} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-3">
                      ...
                      <Button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white focus:ring-2 focus:ring-emerald-300">
          ...
          {variants.length > 0 ? (
            ...
            <div className="text-center py-12 border rounded-md bg-gray-50">
              <div className="flex flex-col items-center">
                ...
                <Button
                  onClick={handleAddVariant}
                  className="mt-4 bg-emerald-600 hover:bg-emerald-700 text-white focus:ring-2 focus:ring-emerald-300"
                  disabled={isAddingVariant || isEditingVariant !== null}
                >
                  <Plus className="h-4 w-4 mr-2" />
      ...
      <CardFooter className="flex justify-end border-t p-4 bg-cherry-500">
        <Button onClick={handleSave} disabled={isSaving} className="bg-emerald-600 hover:bg-emerald-700 text-white focus:ring-2 focus:ring-emerald-300">
          {isSaving ? (
            <>
