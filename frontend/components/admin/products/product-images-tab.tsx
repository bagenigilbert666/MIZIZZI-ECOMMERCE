...
export function ProductImagesTab({
  ...
  useEffect(() => {
    if (cloudinaryLoaded && (window as any).cloudinary && !cloudinaryWidgetRef.current) {
      ...
      cloudinaryWidgetRef.current = (window as any).cloudinary.createMediaLibrary(
        {
  ...
  const removeImage = async (index: number) => {
    ...
    if (permanentImage.id !== undefined && permanentImage.id !== null) {
      imageId = typeof permanentImage.id === "string" ? Number(permanentImage.id) : permanentImage.id
      imageIdOrUrl = imageId.toString()
