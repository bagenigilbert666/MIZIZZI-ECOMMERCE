  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 min-h-[160px] md:min-h-[180px] lg:min-h-[200px]">
        ...
        <div className="relative col-span-1 bg-gradient-to-br from-cherry-600 via-cherry-700 to-cherry-800 p-4 sm:p-6 md:p-8 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 space-y-3 sm:space-y-4 flex flex-col justify-between h-full">
            <div className="space-y-3 sm:space-y-4">
              ...
              >
                Handpicked selection of premium items curated just for you
              </motion.p>
            </div>
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              <p className="text-white/80 text-[10px] font-semibold uppercase tracking-widest">Exclusive Deal</p>
            ...
            >
              <button className="px-5 py-2 bg-white hover:bg-gray-50 text-cherry-700 font-bold text-xs sm:text-sm rounded-lg transition-all duration-300 hover:shadow-lg active:scale-95 uppercase tracking-wide">
                Explore Now
              </button>
            </motion.div>
          </div>
