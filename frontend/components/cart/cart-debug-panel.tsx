...
export function CartDebugPanel() {
  ...
  document.addEventListener("cart-error", handleCartError as unknown as EventListener)

    return () => {
  document.removeEventListener("cart-updated", handleCartUpdate as unknown as EventListener)
  document.removeEventListener("cart-error", handleCartError as unknown as EventListener)
    }
  }, [])
