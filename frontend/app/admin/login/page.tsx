...
import { AdminGoogleAuthButton } from "@/components/admin/auth/admin-google-auth-button"
...
export default function AdminLoginPage() {
  ...
  useEffect(() => {
    // Clear regular user OAuth session to prevent conflicts with admin OAuth
    const clearUserSession = () => {
      // Clear user-specific tokens but keep refresh token
      localStorage.removeItem("user")
      localStorage.removeItem("mizizzi_csrf_token")
      // Note: Keep mizizzi_token in case it's needed, it will be overwritten by admin token
      console.log("[v0] Cleared user session for clean admin OAuth flow")
    }
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          >
            ...
            <p className="text-xl text-white/80 leading-relaxed max-w-md">
              Access powerful tools to monitor, analyze, and grow your business with our comprehensive admin dashboard.
            </p>
          </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-slate-950">
        ...
        >
          ...
          >
            ...
            <AdminGoogleAuthButton fullWidth />
          </motion.form>
