...
export default function Home() {
  return (
    <div
      className="flex min-h-screen flex-col pb-8 overflow-x-hidden max-w-full"
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1200px] px-2 sm:px-4 overflow-hidden">
        <div className="mb-2 rounded bg-white p-2 overflow-hidden">
          <CategoryGrid />
        </div>
      </div>
