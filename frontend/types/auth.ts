...
export interface User {
  ...
  email?: string
  phone?: string
  role?: string | { value: string; label?: string } // Updated to handle both string and object formats
  avatar_url?: string
  is_active?: boolean
  created_at?: string
  last_login?: string
  email_verified?: boolean; // Used for email verification status
  emailVerified?: boolean; // Alias for email_verified for compatibility
